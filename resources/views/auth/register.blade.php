                                ...
                                <div class="account-content mt-3">
                                    ...
                                    @csrf
                                        <div class="form-group row"> 
                                          <div class="col-md-12"> 
                                            <input class="form-control form-control-lg @error('usersname') is-invalid @enderror" type="text" id="usersname" name="usersname" placeholder="ระบุชื่อ-นามสกุล" required
                                            value="{{ old('usersname') }}">
                                            @error('usersname')
                                        ...
                                        <div class="form-group row"> 
                                          <div class="col-md-12"> 
                                            <input class="form-control form-control-lg @error('email') is-invalid @enderror" type="email" id="email" name="email" placeholder="ระบุอีเมล" required
                                            value="{{ old('email') }}">
                                            @error('email')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group row"> 
                                          ...
                                          value="{{ old('tel') }}" placeholder="ระบุหมายเลขโทรศัพท์">  
                                            @error('tel')
                                              <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                              </span>
