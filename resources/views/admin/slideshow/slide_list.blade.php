            ...
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-2"> 
                    <select id="slide_type" name="slide_type" class="form-control mb-1" data-toggle="select2">
...
$(document).on('click', '#search', function(event) { 
    ...
    $('#tbl-data').DataTable().destroy();
    datatable(keywrod, status, slide_type);
  });
  ...
  datatable();
  function datatable(keywrod, status, slide_type){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [   
        ...
        {data: 'slide_type', name: 'slide_type'},
