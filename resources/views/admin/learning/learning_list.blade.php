            ...
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-2"> 
                    <select id="learning_category" name="learning_category" class="form-control mb-1" data-toggle="select2">
...
$(document).on('click', '#search', function(event) { 
    ...
    var learning_category=$('#learning_category').val();
    $('#tbl-data').DataTable().destroy();
    datatable(keywrod, status, learning_category);
  });
  ...
  datatable();
  function datatable(keywrod, status, learning_category){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [  
        {data: 'id', name: 'id'},
        {data: 'learning_title', name: 'learning_title'},  
        {data: 'learning_category', name: 'learning_category'},   
        {data: 'learning_publishing_agency', name: 'learning_publishing_agency'},  
        {data: 'learning_year', name: 'learning_year'},   
