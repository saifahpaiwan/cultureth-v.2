              ...
              <div class="card-header" style="background: #ddd;">  
                <div class="row"> 
                  ...
                  <div class="col-md-3 text-right"> 
                    ...
                    <a href="{{ route('learningcategory.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a> 
                  </div>
                </div>
              </div>
              <div class="card-body">  
                ...
                <div class="table-responsive"> 
                  <table class="table table-borderless nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tbl-learningcategory">
                    <thead>
                      <tr> 
...
<script> 
    ...
    Swal.fire({
        ...
        if (result.value) {  
          ...
          .done(function(data, status, error){   
            if(error.status==200){     
              if(data==true){
                $('#tbl-learningcategory').DataTable().destroy();
                datatable(null, null);
              } 
            }
          })
  ...
  function datatable(keywrod, status){  
    var table = $('#tbl-learningcategory').DataTable({
      "processing":false,  
      "serverSide":false,  
      "searching": false,
      "lengthChange": true,  
      ajax: {
        url:"{{ route('datatable.learningcategory') }}", 
        data:{
          keywrod: keywrod, 
          status: status,
        }
