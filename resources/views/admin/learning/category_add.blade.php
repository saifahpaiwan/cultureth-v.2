          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">   
                  <div class="col-md-6"> 
                    <div class="m-0 h5"> เพิ่มข้อมูลประเภทแหล่งเรียนรู้ </div>
                  </div>
                ...
                <form method="POST" action="{{ route('save.learningcategory') }}" id="form" enctype="multipart/form-data">
                  ...
                  <div class="row"> 
                    <div class="col-md-12 form-group text-right">  
                      <a href="{{ route('learningcategory.list') }}" class="btn btn-lg btn-secondary waves-effect waves-light"> <i class="fe-chevron-left"></i> ย้อนกลับ </a> 
