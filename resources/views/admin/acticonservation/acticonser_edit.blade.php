                  ...
                  <div class="row"> 
                    <div class="col-md-5"> 
                      <div class="row"> 
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ $data['acticonservation_find']->acticonservation_title }}"
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          <textarea class="form-control form-control-lg @error('acticonservation_intro') invalid @enderror" rows="2" id="acticonservation_intro" name="acticonservation_intro" autocomplete="acticonservation_intro" autofocus placeholder="โปรดระบุข้อมูล..." required>{{ $data['acticonservation_find']->acticonservation_intro }}</textarea>
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ $data['acticonservation_find']->acticonservation_meta_title }}"
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ $data['acticonservation_find']->acticonservation_meta_description }}"
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ $data['acticonservation_find']->acticonservation_meta_keyword }}"
                        ...
                        <div class="col-md-6"> 
                          <div class="mb-1">
                            ...
                            <div class="img-file-upload-1"> 
                              <img src="{{ asset('images/acticonservation').'/'.$data['acticonservation_find']->acticonservation_image_thumb_desktop }}" class="event-icon" style="width: 150px; border: 1px solid #ddd;"> 
                            </div>
                            ...
                            <input type="hidden" id="file_upload_hdf" name="file_upload_hdf" value="{{ $data['acticonservation_find']->acticonservation_image_thumb_desktop }}">
                            @error('file_upload') 
                        ...
                        <div class="col-md-6">
                          <div class="mb-1">
                            ...
                            <div class="img-file-upload-2"> 
                              <img src="{{ asset('images/acticonservation').'/'.$data['acticonservation_find']->acticonservation_image_desktop }}" class="event-icon" style="width: 150px; border: 1px solid #ddd;"> 
                            </div>
                            <div class="mt-1 mb-1" style="font-size: 10px;"> Size image 500*400  2MB. </div>
                            ...
                            <input type="hidden" id="file_upload_dektop_hdf" name="file_upload_dektop_hdf" value="{{ $data['acticonservation_find']->acticonservation_image_desktop }}">
                    ...
                    <div class="col-md-7">  
                          ...
                          @if(isset($data['acticonservation_gallery']))
                            @if(count($data['acticonservation_gallery'])>0)
                              @foreach($data['acticonservation_gallery'] as $row)
                                <img src="{{ asset('images/acticonservation/galleries').'/'.$row->image }}" class="event-icon" style="width: 80px; border: 1px solid #ddd;"> 
                              @endforeach
                      ...
                      <div class="mb-2"> 
                        ...
                        <div class="acticonservation_file_text"><?php echo file_get_contents(storage_path().'/app/'.$data['acticonservation_find']->acticonservation_file_text); ?> </div>
                        <input type="hidden" id="acticonservation_file_text" name="acticonservation_file_text" value="">
                        <input type="hidden" id="acticonservation_file_text_hdfs" name="acticonservation_file_text_hdfs" value="{{ $data['acticonservation_find']->acticonservation_file_text }}">  
...
<script>  
  ...
  $(document).on('click', '#close-galleries', function(event) {  
    ...
    Swal.fire({
        ...
        if (result.value) {  
          $.post("{{ route('close.Acticonservation.galleries') }}", {
            _token: "{{ csrf_token() }}",  
            id: id,  
          })
  ...
  $(document).on('click', '#close-pdf', function(event) { 
    ...
    Swal.fire({
        ...
        if (result.value) {  
          $.post("{{ route('close.acticonservation.pdf') }}", {
            _token: "{{ csrf_token() }}",  
            id: id, 
            file: file,
          })
