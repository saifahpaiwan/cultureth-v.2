            ...
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-2"> 
                    <select id="book_type" name="book_type" class="form-control mb-1" data-toggle="select2">
                      <option value=""> เลือกประเภทหนังสือและวารสารสำนัก </option>
...
$(document).on('click', '#search', function(event) { 
    ...
    $('#tbl-data').DataTable().destroy();
    datatable(keywrod, status, book_type);
  });
  ...
  datatable();
  function datatable(keywrod, status, book_type){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [  
        ...
        {data: 'book_publishing_agency', name: 'book_publishing_agency'},   
