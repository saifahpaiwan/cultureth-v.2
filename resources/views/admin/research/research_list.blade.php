            ...
            <div class="card">
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-2"> 
                    <select id="research_type" name="research_type" class="form-control mb-1" data-toggle="select2">
                  ...
                  <table class="table table-borderless nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tbl-data">
                    <thead>
                      <tr> 
                        ...
                        <th> ประเภทงานวิจัยและบทความ </th>
                        <th> ชื่อผู้แต่ง </th>
                        <th> หน่วยงานที่จัดพิมพ์  </th>   
...
$(document).on('click', '#search', function(event) { 
    ...
    $('#tbl-data').DataTable().destroy();
    datatable(keywrod, status, research_type);
  });
  ...
  datatable();
  function datatable(keywrod, status, research_type){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [  
        {data: 'id', name: 'id'},
        {data: 'research_title', name: 'research_title'},  
        {data: 'research_type', name: 'research_type'},   
        {data: 'research_name', name: 'research_name'},  
        {data: 'research_publishing_agency', name: 'research_publishing_agency'},   
