                ...
                <form method="POST" action="{{ route('save.research') }}" id="form" enctype="multipart/form-data">
                  ...
                  <div class="row"> 
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      value="{{ old('research_publishing_agency') }}"
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      <textarea class="form-control form-control-lg @error('research_detial') invalid @enderror" rows="3" id="research_detial" name="research_detial" autocomplete="research_detial" autofocus placeholder="โปรดระบุข้อมูล..." required>{{ old('research_detial') }}</textarea>
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      value="{{ old('research_meta_description') }}"
                    ...
                    <div class="col-md-12 form-group"> 
                      ...
                      value="{{ old('research_meta_keyword') }}"
