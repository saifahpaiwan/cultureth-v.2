                    ...
                    <div class="col-md-5"> 
                      <div class="row"> 
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ old('activity_meta_description') }}"
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ old('activity_meta_keyword') }}"
                    ...
                    <div class="col-md-7">
                      ...
                      <div class="mb-2"> 
                        <label for="activity_file_text">รายละเอียดกิจกรรม <span class="text-danger">*</span></label>
                          <div class="activity_file_text"><?php echo old('activity_file_text'); ?></div>
