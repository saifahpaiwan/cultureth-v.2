              ...
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-3 text-right"> 
                    ...
                    <a href="{{ route('network.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a> 
                  </div>
                </div>
              </div>
              <div class="card-body">  
...
$(document).on('click', '#search', function(event) { 
  ...
  function datatable(keywrod, status, date){  
    var table = $('#tbl-data').DataTable({
      ...
      columns: [  
        {data: 'id', name: 'id'},
        {data: 'network_title', name: 'network_title'},     
