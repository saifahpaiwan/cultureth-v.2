                  ...
                  <div class="row"> 
                    <div class="col-md-5"> 
                      <div class="row"> 
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          <textarea class="form-control form-control-lg @error('network_intro') invalid @enderror" rows="2" id="network_intro" name="network_intro" autocomplete="network_intro" autofocus placeholder="โปรดระบุข้อมูล..." required>{{ old('network_intro') }}</textarea>
                          @error('network_intro')
                            <ul class="parsley-errors-list filled" ><li class="parsley-required">{{ $message }}</li></ul>
                          @enderror
                        </div> 
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ old('network_meta_description') }}"
                        ...
                        <div class="col-md-12 form-group"> 
                          ...
                          value="{{ old('network_meta_keyword') }}"
                    ...
                    <div class="col-md-7">  
                     <label for="network_file_text">รายละเอียดเครือข่ายความร่วมมือ <span class="text-danger">*</span></label>
                      <div class="network_file_text"><?php echo old('network_file_text'); ?></div>
