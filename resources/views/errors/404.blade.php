...
<head>
    ...
    <style> 
        ...
        .bg-main {  
          background: #95549E; 
          background-image: url("{{ asset('images/pikul-white.png') }}");
                        ...
                        <div class="card-body"> 
                            <div class="account-box">
                                <div class="account-logo-box text-center">  
                                  ...
                                  <h4 class="text-uppercase mb-0">404 | NOT FOUND</h4>
                                  <div class="mt-2">ขออภัยเกิดข้อผิดพลาดไม่พบหน้าที่ร้องขอกรุณาลองใหม่อีกครั้ง</div>
                                  
                                  <a href="{{ route('home') }}" class="btn btn-md btn-block btn-primary waves-effect waves-light btn-lg mt-2">
                                  ย้อนกลับหน้าหลัก
                                  </a> 
                                </div>  
                            </div>
