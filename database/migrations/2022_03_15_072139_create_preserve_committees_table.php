...
class CreatePreserveCommitteesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('preserve_committees', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('preserve_committees');
    }
}
